        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Data Kamar Rumah Sakit</h1>
                            <ol class="breadcrumb">
                        ...
                        <div class="col-sm-6">
                            <button type="button" class="btn btn-success float-sm-right ml-2" data-toggle="modal" data-target="#modal-room"><i class="fas fa-plus"></i> Tambah Kamar</button>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="title-modal-form">Tambah Kamar Rumah Sakit</h4>
                        ...
                        <div class="col-12 col-sm-12">
                            <div class="row">
                                <div class="form-group col-12">
                                    <label for="value">Nama Kamar</label>
    ...
    <script>
        $(document).ready(function(){
            $('#tableRoomLists').DataTable({
                ...
                'ajax': {
                    'url':'<?php echo base_url("master/service/room/data"); ?>',
                    'type': 'POST',
