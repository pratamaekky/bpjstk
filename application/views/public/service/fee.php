        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Data Biaya Rumah Sakit</h1>
                            <ol class="breadcrumb">
                        ...
                        <div class="col-sm-6">
                            <button type="button" class="btn btn-success float-sm-right ml-2" data-toggle="modal" data-target="#modal-fee"><i class="fas fa-plus"></i> Tambah Biaya</button>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="title-modal-form">Tambah Biaya Rumah Sakit</h4>
                        ...
                        <div class="col-12 col-sm-12">
                            <div class="row">
                                        ...
                                        <select name="other_fee_id" id="other_fee_id" class="form-control" required="required">
                                            ...
                                            if (!is_null($otherFee)) {
                                                foreach ($otherFee as $fee) {
                                                    echo '<option value="' . $fee->id . '">' . $fee->value . '</option>';
                                                }
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="name" id="name" class="form-control" placeholder="Contoh: Pemasangan Double Lumen" autocomplete="off" required="required" />
                                    </div>
                                </div>
                                <div class="form-group col-12">
    ...
    <script>
        $(document).ready(function(){
            $('#tableFeeLists').DataTable({
                ...
                'ajax': {
                    'url':'<?php echo base_url("master/service/fee/data"); ?>',
                    'type': 'POST',
