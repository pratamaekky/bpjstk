...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Data Tindakan Rumah Sakit</h1>
                            <ol class="breadcrumb">
                        ...
                        <div class="col-sm-6">
                            <button type="button" class="btn btn-success float-sm-right ml-2" data-toggle="modal" data-target="#modal-measure"><i class="fas fa-plus"></i> Tambah Tindakan</button>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <table id="tableMeasureLists" class="table table-hover">
                                        <thead>
                                            <tr>
                                                <th class="dt-head-center">No</th>
                                                <th class="dt-head-center">Ketegori Operasi</th>
                                                <th class="dt-head-center">Spesialisasi</th>
                                                <th class="dt-head-center">Jenis Tindakan</th>
    ...
    <div class="modal fade modal-overflow" id="modal-measure">
        <form name="measureForm" id="measureForm" enctype="multipart/form-data" novalidate="novalidate">
                        ...
                        <div class="col-12 col-sm-12">
                            <div class="row">
                                <div class="form-group col-12">
                                    <label for="category_id">Kategori Operasi</label>
                                    <div class="input-group">
                                        <select name="category_id" id="category_id" class="form-control" required="required">
                                            ...
                                            <?php 
                                            if (!is_null($otCategory)) {
                                                foreach ($otCategory as $otCat) {
                                                    echo '<option value="' . $otCat->id . '">' . $otCat->value . '</option>';
                                                }
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="form-group col-12">
                                    <label for="specialist_id">Spesialisasi</label>
                                    <div class="input-group">
                                        <select name="specialist_id" id="specialist_id" class="form-control" required="required">
                                            <option value="">-- Pilih Spesialisasi --</option>
                                            <?php 
                                            if (!is_null($otSpecialist)) {
                                                foreach ($otSpecialist as $otSpec) {
                                                    echo '<option value="' . $otSpec->id . '">' . $otSpec->value . '</option>';
                                                }
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="form-group col-12">
                                    <label for="value">Jenis Tindakan</label>
                                    <div class="input-group">
    ...
    <script>
        $(document).ready(function(){
            $('#tableMeasureLists').DataTable({
                ...
                'ajax': {
                    'url':'<?php echo base_url("master/service/measure/data"); ?>',
                    'type': 'POST',
                    'data': {"rsid": <?php echo $rsId; ?>, 'action':'#tableMeasureLists'}
                },
                'columns': [
        ...
        $(function() {
            $.validator.setDefaults({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url('master/service/measure/save'); ?>",
                        type: "POST",
